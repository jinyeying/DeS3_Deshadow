...
class SRD:
    ...
    def get_loaders(self, parse_patches=True, validation='SRD'):
        ...
        train_dataset = ShadowDataset(dir=os.path.join(self.config.data.data_dir, 'data', 'SRD'),
                                        n=self.config.training.patch_n,
                                        patch_size=self.config.data.image_size,
                                        transforms=self.transforms,
                                        filelist=None,
                                        parse_patches=parse_patches)
        val_dataset = ShadowDataset(dir=os.path.join(self.config.data.data_dir, 'data', 'SRD'),
                                      n=self.config.training.patch_n,
                                      patch_size=self.config.data.image_size,
                                      transforms=self.transforms,
